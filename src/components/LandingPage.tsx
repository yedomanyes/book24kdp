    ...
    <div style={{
      ...
      {theme === 'dark' ? (
        <div style={{ 
          ...
          pointerEvents: 'none', 
          overflow: 'hidden',
          maskImage: 'radial-gradient(circle at top left, black 10%, transparent 80%)',
          WebkitMaskImage: 'radial-gradient(circle at top left, black 10%, transparent 80%)'
        }}>
          <PixelSnow 
            color="#ffffff"
            flakeSize={0.01}
      ...
      <main style={{ position: 'relative', zIndex: 10, display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '140px', paddingBottom: '100px', textAlign: 'center', padding: '140px 24px 100px' }}>
        ...
        >
          <button 
            ...
            style={{
              background: 'linear-gradient(135deg, #0047FF 0%, #001FD1 100%)',
              ...
              alignItems: 'center',
              gap: '12px',
              boxShadow: '0 8px 30px rgba(0, 71, 255, 0.5), inset 0 2px 4px rgba(255, 255, 255, 0.3)',
            ...
            onMouseEnter={(e) => { 
              ...
              e.currentTarget.style.boxShadow = '0 14px 40px rgba(0, 71, 255, 0.7), inset 0 2px 4px rgba(255, 255, 255, 0.4)';
              e.currentTarget.style.filter = 'brightness(1.15)';
            }}
            onMouseLeave={(e) => { 
              e.currentTarget.style.transform = 'translateY(0)'; 
              e.currentTarget.style.boxShadow = '0 8px 30px rgba(0, 71, 255, 0.5), inset 0 2px 4px rgba(255, 255, 255, 0.3)';
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            {(['datenschutz', 'privacy', 'terms', 'impressum'] as LegalPage[]).map((p) => (
              <button key={p} onClick={() => setLegalPage(p)} style={{ background: 'none', border: 'none', padding: 0, color: '#525252', fontSize: '13px', cursor: 'pointer', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={e => e.currentTarget.style.color = '#737373'} onMouseLeave={e => e.currentTarget.style.color = '#525252'}>
                {p === 'datenschutz' ? 'Datenschutz' : p === 'privacy' ? 'Privacy Policy' : p === 'terms' ? 'AGB' : 'Impressum'}
              </button>
            ))}
          </div>
        </div>
